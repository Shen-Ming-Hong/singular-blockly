/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/feedback/wrangler.jsonc --env-interface=FeedbackEnv workers/feedback/worker-configuration.d.ts` (hash: 073cf5e6eca720399c019cbdd18e760a)
// Runtime types generated with workerd@1.20260815.1 2026-08-19
interface __BaseEnv_FeedbackEnv {
	FEEDBACK_SCREENSHOTS: R2Bucket;
	FEEDBACK_DB: D1Database;
	REPORTER_RATE_LIMITER: RateLimit;
	...
	CLOUDFLARE_ACCESS_AUD: "6abf44e50fdca184c1cb1768bfbde831b6df7dc469ee1b8da17ff2283a2c210d";
	PRIVATE_GITHUB_REPOSITORY: "Shen-Ming-Hong/singular-blockly-feedback";
	PUBLIC_GITHUB_REPOSITORY: "Shen-Ming-Hong/singular-blockly";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env extends __BaseEnv_FeedbackEnv {}
}
interface FeedbackEnv extends __BaseEnv_FeedbackEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_ORIGIN" | "CLOUDFLARE_ACCESS_TEAM_DOMAIN" | "CLOUDFLARE_ACCESS_AUD" | "PRIVATE_GITHUB_REPOSITORY" | "PUBLIC_GITHUB_REPOSITORY">> {}
}
