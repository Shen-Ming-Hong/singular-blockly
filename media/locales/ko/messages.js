...
window.languageManager.loadMessages('ko', {
	...
	DIAG_REPORT_TITLE: 'MCP Server 진단 보고서',
	DIAG_NODEJS_VERSION: 'Node.js 버전',
	DIAG_VERSION_TOO_LOW: '버전이 너무 낮습니다 ({0}, >= 22.16.0 필요)',
	DIAG_MCP_BUNDLE: 'MCP Server Bundle',
	DIAG_EXISTS: '존재함',
	DIAG_FILE_NOT_FOUND: '파일을 찾을 수 없음',
	DIAG_VSCODE_API_VERSION: 'VSCode API 버전',
	DIAG_REQUIRES_VERSION: '>= {0} 필요',
	DIAG_WORKSPACE_PATH: '작업 영역 경로',
	DIAG_NONE: '없음',
	DIAG_NODEJS_PATH: 'Node.js 경로',
	DIAG_SYSTEM_PATH: '시스템 PATH',
	DIAG_STATUS: '상태',
	DIAG_STATUS_OPERATIONAL: 'MCP Server가 정상 작동 중입니다',
	DIAG_STATUS_PARTIAL: 'MCP Server가 부분적으로 사용 가능합니다',
	DIAG_STATUS_UNAVAILABLE: 'MCP Server를 사용할 수 없습니다',
	DIAG_RECOMMENDATIONS: '권장 사항',
	DIAG_GENERATED_AT: '생성 시간',
	DIAG_NODEJS_STATUS: 'Node.js 상태',
	DIAG_AVAILABLE: '사용 가능',
	DIAG_YES: '예',
	DIAG_NO: '아니오',
	DIAG_COMPATIBLE: '호환됨',
	DIAG_ERROR: '오류',
	...
	DIAG_SUPPORTED: '지원됨',
	DIAG_VERSION: '버전',
	DIAG_OVERALL_STATUS: '전체 상태',
	DIAG_OPERATIONAL_SHORT: '정상',
	DIAG_PARTIAL_SHORT: '부분 사용 가능',
	DIAG_UNAVAILABLE_SHORT: '사용 불가',
	REC_INSTALL_NODEJS: 'Node.js 22.16.0 이상을 설치하세요',
	REC_SET_NODEJS_PATH: '이미 설치된 경우 설정에서 Node.js 경로를 지정하세요 (singularBlockly.mcp.nodePath)',
	REC_UPGRADE_NODEJS: 'Node.js를 22.16.0 이상으로 업그레이드하세요 (현재: {0})',
	REC_RUN_COMPILE: '`npm run compile`을 실행하거나 확장 프로그램을 다시 설치하세요',
	REC_UPGRADE_VSCODE: 'VSCode를 1.105.0 이상으로 업그레이드하세요',
	REC_OPEN_PROJECT: '전체 기능을 사용하려면 프로젝트 폴더를 열어주세요',
	...
	ERROR_ARDUINO_NO_DEVICE: '장치가 감지되지 않습니다. 보드가 연결되어 있는지 확인하세요.',
	ERROR_ARDUINO_PORT_BUSY: '포트가 다른 프로그램에서 사용 중입니다. 다른 시리얼 모니터를 닫아주세요.',
	ERROR_ARDUINO_DEVICE_DISCONNECT: '업로드 중 장치 연결이 끊어졌습니다.',
	ERROR_ARDUINO_UPLOAD_TIMEOUT: '업로드 시간이 초과되었습니다. 연결을 확인하세요.',
	ERROR_ARDUINO_UPLOAD_CONNECTION: '업로드에 실패했습니다. 장치 연결을 확인하세요.',
	...
	// === TXT Controller ===
	UPLOAD_BUTTON_TITLE_TXT: 'TXT 컨트롤러에 업로드',
	TXT_CONNECTION_PANEL_TITLE: 'TXT 컨트롤러 연결 설정',
	TXT_HOST_LABEL: '호스트 IP',
	TXT_USERNAME_LABEL: '사용자 이름',
	TXT_PASSWORD_LABEL: '비밀번호',
	...
	TXT_CONFIG_SAVED: '설정이 저장되었습니다',
	TXT_UPLOAD_STAGE_CONNECTING: 'TXT 컨트롤러에 연결 중...',
	TXT_UPLOAD_STAGE_UPLOADING: '프로그램 업로드 중...',
	TXT_UPLOAD_STAGE_EXECUTING: '프로그램 실행 중...',
	TXT_UPLOAD_STAGE_COMPLETED: '완료',
	TXT_UPLOAD_STAGE_FAILED: '업로드 실패',
	TXT_RUN_SUCCESS: '프로그램 완료',
	TXT_RUN_FAILED: '프로그램 실행 실패: {0}',
	TXT_STOP_SUCCESS: '프로그램 중지됨',
	TXT_INIT: 'TXT 컨트롤러 초기화',
	TXT_INIT_TOOLTIP: 'fischertechnik TXT 컨트롤러에 연결',
	TXT_MOTOR_SPEED: '모터',
	TXT_MOTOR_SPEED_SET: '속도 설정',
	TXT_MOTOR_SPEED_TOOLTIP: '모터 속도 설정 (-512 ~ 512)',
	TXT_MOTOR_STOP: '모터 정지',
	TXT_MOTOR_STOP_TOOLTIP: '지정된 모터 정지',
	TXT_OUTPUT: '출력',
	TXT_OUTPUT_SET: '설정',
	TXT_OUTPUT_TOOLTIP: '출력을 켜거나 끄도록 설정',
	TXT_INPUT_READ: '입력 읽기',
	TXT_INPUT_READ_TOOLTIP: '디지털 입력값 읽기',
	TXT_INPUT_SENSOR_PREFIX: '읽기',
	TXT_SENSOR_BUTTON: '버튼',
	TXT_SENSOR_GATE: '포토센서',
	TXT_SENSOR_ULTRASONIC: '초음파',
	TXT_INPUT_SENSOR_TOOLTIP: '센서 유형을 선택하고 입력값을 읽습니다 (버튼/포토센서는 0 또는 1, 초음파는 거리 cm)',
	TXT_WAIT: '대기',
	TXT_WAIT_UNIT: '밀리초',
	TXT_WAIT_TOOLTIP: '지정된 밀리초 동안 대기',
	TXT_STOP_ALL: '모든 모터 및 출력 정지',
	TXT_STOP_ALL_TOOLTIP: '모든 모터를 정지하고 모든 출력을 끕니다',
	TXT_DIRECTION_FORWARD: '정방향',
	TXT_DIRECTION_BACKWARD: '역방향',
	TXT_STATE_ON: '켜기',
	TXT_STATE_OFF: '끄기',
		TXT_MAIN: 'TXT 메인 프로그램',
	TXT_MAIN_TOOLTIP: 'TXT Controller의 메인 진입점입니다. 모든 블록은 여기에 배치해야 합니다.',
	TXT_ORPHAN_WARNING: '이 블록은 "TXT 메인" 블록 안에 배치해야 합니다',
