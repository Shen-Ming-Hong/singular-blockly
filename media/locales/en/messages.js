...
window.languageManager.loadMessages('en', {
	...
	DIAG_REPORT_TITLE: 'MCP Server Diagnostic Report',
	DIAG_NODEJS_VERSION: 'Node.js Version',
	DIAG_VERSION_TOO_LOW: 'Version too low ({0}, requires >= 22.16.0)',
	DIAG_MCP_BUNDLE: 'MCP Server Bundle',
	DIAG_EXISTS: 'Exists',
	DIAG_FILE_NOT_FOUND: 'File not found',
	DIAG_VSCODE_API_VERSION: 'VSCode API Version',
	DIAG_REQUIRES_VERSION: 'requires >= {0}',
	DIAG_WORKSPACE_PATH: 'Workspace Path',
	DIAG_NONE: 'None',
	DIAG_NODEJS_PATH: 'Node.js Path',
	DIAG_SYSTEM_PATH: 'System PATH',
	DIAG_STATUS: 'Status',
	DIAG_STATUS_OPERATIONAL: 'MCP Server is operational',
	DIAG_STATUS_PARTIAL: 'MCP Server is partially available',
	DIAG_STATUS_UNAVAILABLE: 'MCP Server is unavailable',
	DIAG_RECOMMENDATIONS: 'Recommendations',
	DIAG_GENERATED_AT: 'Generated at',
	...
	DIAG_OPERATIONAL_SHORT: 'Operational',
	DIAG_PARTIAL_SHORT: 'Partially available',
	DIAG_UNAVAILABLE_SHORT: 'Unavailable',
	REC_INSTALL_NODEJS: 'Install Node.js 22.16.0 or later',
	REC_SET_NODEJS_PATH: 'If already installed, specify the Node.js path in settings (singularBlockly.mcp.nodePath)',
	REC_UPGRADE_NODEJS: 'Upgrade Node.js to 22.16.0 or later (current: {0})',
	REC_RUN_COMPILE: 'Run `npm run compile` or reinstall the extension',
	REC_UPGRADE_VSCODE: 'Upgrade VSCode to 1.105.0 or later',
	REC_OPEN_PROJECT: 'Open a project folder to use full features',
