...
window.languageManager.loadMessages('pl', {
	...
	DIAG_REPORT_TITLE: 'Raport Diagnostyczny MCP Server',
	DIAG_NODEJS_VERSION: 'Wersja Node.js',
	DIAG_VERSION_TOO_LOW: 'Wersja zbyt niska ({0}, wymaga >= 22.16.0)',
	DIAG_MCP_BUNDLE: 'MCP Server Bundle',
	DIAG_EXISTS: 'Istnieje',
	DIAG_FILE_NOT_FOUND: 'Plik nie znaleziony',
	DIAG_VSCODE_API_VERSION: 'Wersja API VSCode',
	DIAG_REQUIRES_VERSION: 'wymaga >= {0}',
	DIAG_WORKSPACE_PATH: 'Ścieżka obszaru roboczego',
	DIAG_NONE: 'Brak',
	DIAG_NODEJS_PATH: 'Ścieżka Node.js',
	DIAG_SYSTEM_PATH: 'Systemowy PATH',
	DIAG_STATUS: 'Status',
	DIAG_STATUS_OPERATIONAL: 'MCP Server działa prawidłowo',
	DIAG_STATUS_PARTIAL: 'MCP Server jest częściowo dostępny',
	DIAG_STATUS_UNAVAILABLE: 'MCP Server jest niedostępny',
	DIAG_RECOMMENDATIONS: 'Zalecenia',
	DIAG_GENERATED_AT: 'Wygenerowano',
	DIAG_NODEJS_STATUS: 'Status Node.js',
	DIAG_AVAILABLE: 'Dostępny',
	DIAG_YES: 'Tak',
	DIAG_NO: 'Nie',
	DIAG_COMPATIBLE: 'Kompatybilny',
	DIAG_ERROR: 'Błąd',
	DIAG_PATH: 'Ścieżka',
	DIAG_SUPPORTED: 'Obsługiwany',
	DIAG_VERSION: 'Wersja',
	DIAG_OVERALL_STATUS: 'Status ogólny',
	DIAG_OPERATIONAL_SHORT: 'Działa',
	DIAG_PARTIAL_SHORT: 'Częściowo dostępny',
	DIAG_UNAVAILABLE_SHORT: 'Niedostępny',
	REC_INSTALL_NODEJS: 'Zainstaluj Node.js 22.16.0 lub nowszy',
	REC_SET_NODEJS_PATH: 'Jeśli już zainstalowany, określ ścieżkę do Node.js w ustawieniach (singularBlockly.mcp.nodePath)',
	REC_UPGRADE_NODEJS: 'Zaktualizuj Node.js do wersji 22.16.0 lub nowszej (obecna: {0})',
	REC_RUN_COMPILE: 'Uruchom `npm run compile` lub ponownie zainstaluj rozszerzenie',
	REC_UPGRADE_VSCODE: 'Zaktualizuj VSCode do wersji 1.105.0 lub nowszej',
	REC_OPEN_PROJECT: 'Otwórz folder projektu, aby korzystać ze wszystkich funkcji',
	...
	// HuskyLens ID-Based Bloki
	HUSKYLENS_BY_ID_LABEL: 'Zapytanie po ID',
	HUSKYLENS_REQUEST_BLOCKS_ID: 'żądaj bloków HUSKYLENS z ID',
	HUSKYLENS_REQUEST_BLOCKS_ID_SUFFIX: '',
	HUSKYLENS_REQUEST_BLOCKS_ID_TOOLTIP: 'Żądaj tylko bloków z określonym ID dla lepszej wydajności',
	HUSKYLENS_COUNT_BLOCKS_ID: 'liczba bloków HUSKYLENS z ID',
	HUSKYLENS_COUNT_BLOCKS_ID_SUFFIX: '',
	HUSKYLENS_COUNT_BLOCKS_ID_TOOLTIP: 'Pobierz liczbę bloków z określonym ID',
	HUSKYLENS_GET_BLOCK_ID: 'pobierz blok z ID',
	HUSKYLENS_GET_BLOCK_ID_INDEX: 'indeks',
	HUSKYLENS_GET_BLOCK_ID_INDEX_SUFFIX: '',
	HUSKYLENS_GET_BLOCK_ID_TOOLTIP: 'Pobierz pozycję, rozmiar lub ID bloku z określonym ID',
	...
	SAFETY_GUARD_CANCELLED: 'Nie ma problemu! Nic nie zmieniliśmy.',
	SAFETY_GUARD_SUPPRESSED: 'Jasne! Nie będziemy już o to pytać.',
	...
	CYBERBRICK_TICKS_MS: 'Pobierz bieżące milisekundy',
	CYBERBRICK_TICKS_MS_TOOLTIP: 'Pobierz bieżący licznik milisekund',
	CYBERBRICK_TICKS_DIFF_PREFIX: 'Różnica czasu',
	CYBERBRICK_TICKS_DIFF_NOW: 'teraz',
	CYBERBRICK_TICKS_DIFF_START: 'początek',
	CYBERBRICK_TICKS_DIFF_TOOLTIP: 'Oblicz milisekundy między teraz a początkiem',
	...
	// === Sample Browser ===
	SAMPLE_BROWSER_BUTTON_TITLE: 'Załaduj przykład',
	SAMPLE_BROWSER_TITLE: 'Przykłady CyberBrick',
	SAMPLE_BROWSER_LOADING: 'Ładowanie przykładów...',
	SAMPLE_BROWSER_OFFLINE_NOTICE: 'Używanie wbudowanej wersji (offline)',
	SAMPLE_BROWSER_LOAD_BUTTON: 'Załaduj',
	SAMPLE_BROWSER_EMPTY: 'Brak dostępnych przykładów',
	SAMPLE_BROWSER_CONFIRM_LOAD: 'Spowoduje to zastąpienie bieżącego obszaru roboczego. Kontynuować?',
	SAMPLE_BROWSER_CONFIRM_YES: 'Załaduj przykład',
	SAMPLE_BROWSER_CONFIRM_NO: 'Anuluj',
	SAMPLE_BROWSER_ERROR_INVALID: 'Nieprawidłowy format przykładu, nie można załadować',

	// === TXT Controller ===
	UPLOAD_BUTTON_TITLE_TXT: 'Prześlij do TXT Controller',
	TXT_CONNECTION_PANEL_TITLE: 'Ustawienia połączenia TXT Controller',
	TXT_HOST_LABEL: 'IP hosta',
	TXT_USERNAME_LABEL: 'Nazwa użytkownika',
	TXT_PASSWORD_LABEL: 'Hasło',
	...
	TXT_CONFIG_SAVED: 'Ustawienia zapisane',
	TXT_UPLOAD_STAGE_CONNECTING: 'Łączenie z TXT Controller...',
	TXT_UPLOAD_STAGE_UPLOADING: 'Przesyłanie programu...',
	TXT_UPLOAD_STAGE_EXECUTING: 'Wykonywanie programu...',
	TXT_UPLOAD_STAGE_COMPLETED: 'Ukończono',
	TXT_UPLOAD_STAGE_FAILED: 'Przesyłanie nieudane',
	TXT_RUN_SUCCESS: 'Program zakończony',
	TXT_RUN_FAILED: 'Błąd wykonania programu: {0}',
	TXT_STOP_SUCCESS: 'Program zatrzymany',
	// Test Panel UI
	TXT_TEST_PANEL_TITLE: 'Panel testowy TXT I/O',
	TXT_TEST_PANEL_BUTTON_TITLE: 'Panel testowy TXT I/O',
	TXT_TEST_MOTORS_TITLE: 'Silniki',
	TXT_TEST_OUTPUTS_TITLE: 'Wyjścia',
	TXT_TEST_INPUTS_TITLE: 'Wejścia',
	TXT_TEST_STOP_ALL: 'ZATRZYMAJ WSZYSTKO',
	TXT_TEST_MOTOR_FWD: '▶ Przód',
	TXT_TEST_MOTOR_BWD: '◀ Tył',
	TXT_TEST_STATUS_CONNECTED: 'Połączono',
	TXT_TEST_STATUS_DISCONNECTED: 'Rozłączono',
	TXT_TEST_STATUS_PAUSED: 'Wstrzymano',
	TXT_TEST_STATUS_CONNECTING: 'Łączenie…',
	TXT_SETUP: 'Inicjalizacja TXT',
	TXT_SETUP_TOOLTIP: 'Inicjalizuje kontroler TXT tylko raz i przygotowuje współdzielone zasoby sprzętowe dla wszystkich procesów TXT.',
	TXT_PROCESS_PREFIX: 'Proces TXT:',
	TXT_PROCESS_TOOLTIP: 'Definiuje jeden proces TXT. Nazwa jest opcjonalna i służy tylko do wyświetlania lub diagnostyki.',
	TXT_INIT: 'Inicjalizuj TXT Controller',
	TXT_INIT_TOOLTIP: 'Połącz z fischertechnik TXT Controller',
	TXT_MOTOR_SPEED: 'Silnik',
	TXT_MOTOR_SPEED_SET: 'ustaw prędkość',
	TXT_MOTOR_SPEED_TOOLTIP: 'Ustaw prędkość silnika (-512 do 512)',
	TXT_MOTOR_STOP: 'Zatrzymaj silnik',
	TXT_MOTOR_STOP_TOOLTIP: 'Zatrzymaj wskazany silnik',
	TXT_OUTPUT: 'Wyjście',
	TXT_OUTPUT_SET: 'ustaw',
	TXT_OUTPUT_TOOLTIP: 'Włącz lub wyłącz wyjście',
	TXT_INPUT_READ: 'Odczytaj wejście',
	TXT_INPUT_READ_TOOLTIP: 'Odczytaj wartość wejścia cyfrowego',
	TXT_INPUT_SENSOR_PREFIX: 'Odczytaj',
	TXT_SENSOR_BUTTON: 'Przycisk',
	TXT_SENSOR_GATE: 'Bramka świetlna',
	TXT_SENSOR_ULTRASONIC: 'Ultradźwięk',
	TXT_INPUT_SENSOR_TOOLTIP: 'Wybierz typ czujnika i odczytaj wartość (przycisk/bramka świetlna zwraca 0 lub 1, ultradźwięk zwraca odległość w cm)',
	TXT_WAIT: 'Czekaj',
	TXT_WAIT_UNIT: 'ms',
	TXT_WAIT_TOOLTIP: 'Czekaj określoną liczbę milisekund',
	TXT_STOP_ALL: 'Zatrzymaj wszystkie silniki i wyjścia',
	TXT_STOP_ALL_TOOLTIP: 'Zatrzymaj wszystkie silniki i wyłącz wszystkie wyjścia',
	TXT_DIRECTION_FORWARD: 'do przodu',
	TXT_DIRECTION_BACKWARD: 'do tyłu',
	TXT_STATE_ON: 'WŁ',
	TXT_STATE_OFF: 'WYŁ',
		TXT_MAIN: 'Program Główny TXT',
	TXT_MAIN_TOOLTIP: 'Główny punkt wejścia dla TXT Controller. Wszystkie bloki muszą być umieszczone tutaj.',
	TXT_ORPHAN_WARNING: 'Ten blok musi być umieszczony w bloku "Program główny TXT"',
	TXT_ORPHAN_WARNING_MULTI: 'Ten blok musi być umieszczony w bloku „Inicjalizacja TXT” lub „Proces TXT”',
	TXT_SETUP_DUPLICATE_WARNING: 'Wykryto wiele bloków „Inicjalizacja TXT”. Usuń zbędne bloki.',
