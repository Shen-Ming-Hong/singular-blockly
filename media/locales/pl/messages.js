...
window.languageManager.loadMessages('pl', {
	...
	CYBERBRICK_UPLOAD_SETTINGS_CANCEL: 'Zamknij',
	...
	CYBERBRICK_PAIRED_DEVICES_TITLE: 'Moje CyberBrick',
	CYBERBRICK_PROVISIONING_TITLE: 'Dodaj bezprzewodowe przesłanie dla CyberBrick',
	CYBERBRICK_NAME_ERROR_EMPTY: 'Wpisz nazwę.',
	CYBERBRICK_NAME_ERROR_STARTS_WITH_NUMBER: 'Nazwa nie może zaczynać się od cyfry.',
	CYBERBRICK_NAME_ERROR_CONTAINS_WHITESPACE: 'Usuń spacje z nazwy.',
	CYBERBRICK_NAME_ERROR_CONTAINS_HYPHEN: 'Użyj podkreślenia (_) zamiast myślnika (-).',
	CYBERBRICK_NAME_ERROR_INVALID_CHARACTER: 'Użyj tylko liter, cyfr, podkreśleń lub znaków chińskich.',
	CYBERBRICK_NAME_ERROR_PYTHON_KEYWORD: 'To zastrzeżone słowo MicroPython. Wybierz inną nazwę.',
	CYBERBRICK_NAME_ERROR_DUPLICATE_FUNCTION: 'Inna funkcja już używa tej nazwy.',
	CYBERBRICK_NAME_ERROR_DUPLICATE_PARAMETER: 'Ta funkcja ma już parametr o tej nazwie.',
	CYBERBRICK_NAME_WARNING_RUNTIME: 'Ta nazwa może zasłonić funkcję urządzenia MicroPython.',
	CYBERBRICK_NAME_WARNING_BUILTIN: 'Ta nazwa może zasłonić wbudowaną funkcję Python.',
	CYBERBRICK_NAME_UPLOAD_BLOCKED: 'Popraw zaznaczone nazwy CyberBrick przed przesłaniem.',
	CYBERBRICK_PROVISION_RUNNING: 'Konfigurowanie przesyłania bezprzewodowego',
	CYBERBRICK_PROVISION_CURRENT_STAGE: 'Bieżący krok',
	CYBERBRICK_PROVISION_KEEP_CONNECTED: 'Nie naciskaj ponownie ani nie odłączaj kabla USB.',
	CYBERBRICK_PROVISION_RETRY: 'Sprawdź ten krok i spróbuj ponownie.',
	CYBERBRICK_PROVISION_IN_PROGRESS: 'Konfiguracja bezprzewodowa już trwa.',
	CYBERBRICK_USB_PORT_LABEL: 'USB Port',
	CYBERBRICK_USB_PORT_REFRESH: 'Refresh',
	CYBERBRICK_FRIENDLY_NAME_LABEL: 'Nadaj nazwę swojemu CyberBrick',
	CYBERBRICK_WIFI_SSID_LABEL: 'Nazwa Wi-Fi',
	CYBERBRICK_WIFI_SSID_EMPTY_PLACEHOLDER: 'Nie znaleziono sieci Wi-Fi',
	CYBERBRICK_WIFI_SCAN_BUTTON: 'Rescan',
	CYBERBRICK_WIFI_PASSWORD_LABEL: 'Wi-Fi Password',
	CYBERBRICK_WIFI_PASSWORD_SHOW: 'Pokaż hasło Wi-Fi',
	CYBERBRICK_WIFI_PASSWORD_HIDE: 'Ukryj hasło Wi-Fi',
	CYBERBRICK_PROVISION_BUTTON: 'Skonfiguruj bezprzewodowe przesłanie',
	CYBERBRICK_OTA_CLEANUP_TITLE: 'Ustawienia zaawansowane',
	...
	CYBERBRICK_OTA_CLEANUP_BUTTON: 'Usuń bezprzewodowe przesłanie',
	...
	CYBERBRICK_PAIRED_DEVICES_EMPTY: 'Nie dodano żadnego CyberBrick. Rozwiń poniżej „Dodaj bezprzewodowe przesłanie dla CyberBrick“.',
	CYBERBRICK_DEVICE_IP_UNKNOWN: 'IP not known',
	CYBERBRICK_SET_PRIMARY_BUTTON: 'Wybierz',
	CYBERBRICK_DELETE_DEVICE_BUTTON: 'Usuń',
	CYBERBRICK_WIFI_PASSWORD_STORED: 'A Wi-Fi password is stored securely for the selected device.',
	CYBERBRICK_WIFI_PASSWORD_NOT_STORED: 'Hasło Wi-Fi zostanie bezpiecznie zapisane po konfiguracji.',
	CYBERBRICK_DELETE_DEVICE_CONFIRM: 'Usunąć ten CyberBrick?',
	...
	CYBERBRICK_PROVISION_STEP_DETECT_USB: 'Wybrano port USB CyberBrick.',
	CYBERBRICK_PROVISION_STEP_READ_DEVICE_ID_FOUND: 'Znaleziono tożsamość urządzenia.',
	CYBERBRICK_PROVISION_STEP_READ_DEVICE_ID_CREATING: 'Tworzenie tożsamości urządzenia.',
	CYBERBRICK_PROVISION_STEP_READ_DEVICE_ID_CREATED: 'Utworzono tożsamość urządzenia.',
	CYBERBRICK_PROVISION_STEP_INSTALL_AGENT: 'Agent OTA zainstalowany.',
	CYBERBRICK_PROVISION_STEP_CONFIGURE_WIFI: 'Wi-Fi skonfigurowane.',
	CYBERBRICK_PROVISION_STEP_CONFIGURE_WIFI_NO_IP: 'Konfiguracja Wi-Fi zapisana; IP nie zostało jeszcze zgłoszone.',
	CYBERBRICK_PROVISION_STEP_STORE_SECRETS: 'Sekrety zapisano bezpiecznie.',
	CYBERBRICK_PROVISION_STEP_VERIFY_AGENT: 'Sprawdzanie agenta OTA.',
	CYBERBRICK_PROVISION_STEP_DETECT_USB_FAILED: 'Nie można użyć połączenia USB CyberBrick.',
	CYBERBRICK_PROVISION_STEP_READ_DEVICE_ID_FAILED: 'Nie można odczytać ani utworzyć tożsamości urządzenia.',
	CYBERBRICK_PROVISION_STEP_INSTALL_AGENT_FAILED: 'Nie można zainstalować agenta OTA.',
	CYBERBRICK_PROVISION_STEP_CONFIGURE_WIFI_FAILED: 'Nie można dokończyć konfiguracji Wi-Fi.',
	CYBERBRICK_PROVISION_STEP_VERIFY_AGENT_FAILED: 'Nie można zweryfikować agenta OTA.',
	CYBERBRICK_PROVISION_STEP_STORE_SECRETS_FAILED: 'Nie można zapisać danych parowania i zabezpieczeń.',
	CYBERBRICK_PROVISION_STEP_UNKNOWN: 'Zaktualizowano krok konfiguracji OTA.',
	CYBERBRICK_PROVISION_SUCCEEDED: 'Konfiguracja OTA CyberBrick zakończona. Tryb wgrywania pozostaje USB.',
	CYBERBRICK_OTA_RC_CHANNEL_NOTE: 'Uwaga o kanale RC: Oba z Wi-Fi → kanał Wi-Fi, RC i OTA działają. Bez Wi-Fi → skonfigurowany kanał, RC działa. Jedno z Wi-Fi, drugie bez → RC może nie sparować.',
	CYBERBRICK_PROVISION_FAILED: 'Konfiguracja OTA CyberBrick nie powiodła się.',
	...
	CYBERBRICK_ERROR_AGENT_UNREACHABLE: 'Nie można było połączyć się z agentem OTA CyberBrick.',
	CYBERBRICK_ERROR_OFFLINE: 'CyberBrick wydaje się być offline.',
	CYBERBRICK_ERROR_AGENT_HEALTH: 'Agent OTA CyberBrick nie jest gotowy.',
	CYBERBRICK_ERROR_MISSING_PRIMARY: 'Nie wybrano urządzenia CyberBrick dla OTA.',
	CYBERBRICK_ERROR_NOT_PAIRED: 'CyberBrick nie jest skonfigurowany dla OTA.',
	CYBERBRICK_ERROR_MISSING_ADDRESS: 'Adres IP CyberBrick jest nieznany.',
	CYBERBRICK_ERROR_MISSING_TOKEN: 'CyberBrick nie ma tokenu OTA.',
	CYBERBRICK_ERROR_TOKEN_REJECTED: 'CyberBrick odrzucił token OTA.',
	CYBERBRICK_ERROR_IDENTITY_MISMATCH: 'CyberBrick odrzucił żądanie przesyłania.',
	CYBERBRICK_ERROR_WRITE_FAILED: 'Zapis OTA CyberBrick nie powiódł się.',
	CYBERBRICK_ERROR_NETWORK: 'Błąd sieci podczas połączenia z CyberBrick.',
	...
	TOOLBAR_ACTIONS_EXPAND: 'Pokaż więcej działań',
	TOOLBAR_ACTIONS_COLLAPSE: 'Pokaż mniej działań',
	...
	WORKSPACE_CANDIDATE_INVALID_WARNING: 'Nieprawidłowa zewnętrzna zmiana obszaru roboczego została odizolowana, a ostatnia prawidłowa wersja przywrócona. Szczegóły: blockly/main.invalid.json',
	WORKSPACE_CANDIDATE_QUARANTINED_WARNING: 'Nieprawidłowa zewnętrzna zmiana obszaru roboczego została odizolowana, ale nie było dostępnej ostatniej prawidłowej wersji do przywrócenia. Szczegóły: blockly/main.invalid.json',
	WORKSPACE_CANDIDATE_SHOW_DETAILS: 'Pokaż szczegóły danych wyjściowych',
	...
	PLATFORMIO_DIAGNOSTIC_CORE_ENVIRONMENTS_TITLE: 'Środowiska Core',
	PLATFORMIO_DIAGNOSTIC_PROVIDER_CORE: 'Core rozszerzenia PlatformIO',
	PLATFORMIO_DIAGNOSTIC_MANAGED_CORE: 'Core zarządzany przez Singular',
	PLATFORMIO_DIAGNOSTIC_ARDUINO_SELECTION: 'Trasowanie Arduino',
	PLATFORMIO_DIAGNOSTIC_PYTHON_SELECTION: 'Trasowanie Python',
	PLATFORMIO_DIAGNOSTIC_PACKAGE_STATUS: 'Stan pakietów',
	PLATFORMIO_DIAGNOSTIC_STORAGE_USAGE: 'Użycie pamięci',
	PLATFORMIO_DIAGNOSTIC_FALLBACK_USED: 'Użyto rozwiązania zapasowego',
	PLATFORMIO_DIAGNOSTIC_ACTION_REPAIR_MANAGED_RUNTIME: 'Napraw środowisko zarządzane',
	PLATFORMIO_DIAGNOSTIC_ACTION_CLEANUP_MANAGED_RUNTIME: 'Wyczyść pliki zarządzane',
	PLATFORMIO_DIAGNOSTIC_ACTION_REVEAL_MANAGED_RUNTIME: 'Otwórz folder Singular Core',
	PLATFORMIO_DIAGNOSTIC_MANAGED_REPAIR_STARTED: 'Trwa naprawa środowiska zarządzanego. Może być wymagane pobieranie.',
	PLATFORMIO_DIAGNOSTIC_MANAGED_REPAIR_SUCCESS: 'Naprawa środowiska zarządzanego została ukończona.',
	PLATFORMIO_DIAGNOSTIC_MANAGED_REPAIR_FAILED: 'Naprawa nie powiodła się. Szczegóły z ukrytymi danymi znajdują się w dzienniku wyjściowym.',
	PLATFORMIO_DIAGNOSTIC_MANAGED_CLEANUP_SUCCESS: 'Czyszczenie zakończone: usunięto {0} pobrań, {1} katalogów tymczasowych i {2} starych wersji.',
	PLATFORMIO_DIAGNOSTIC_MANAGED_CLEANUP_FAILED: 'Czyszczenie nie powiodło się. Nieznane pliki pozostały bez zmian.',
	PLATFORMIO_DIAGNOSTIC_MANAGED_REVEAL_FAILED:
		'Nie można otworzyć folderu Singular Core. Zakończ inicjalizację lub napraw zarządzane środowisko i spróbuj ponownie.',
	...
	PLATFORMIO_REPAIR_ACTION_CREATE_ISSUE_DRAFT: 'Prześlij opinię',
	...
	PLATFORMIO_REPAIR_FEEDBACK_OPENED: 'Formularz opinii został otwarty z ukrytymi prywatnymi danymi PlatformIO. Przed wysłaniem sprawdź wszystkie dane.',
	PLATFORMIO_REPAIR_FEEDBACK_PREFILL: 'Diagnostyka PlatformIO nie ukończyła oczekiwanego procesu.\nStan ogólny: {0}.\nTesty, których dotyczy problem: {1}.\nOpisz wykonywane czynności i oczekiwany wynik.',
	...
	RC_MASTER_INIT_TOOLTIP: 'Inicjalizuj nadajnik RC z ID parowania (1-255) i kanałem (1-11). Uwaga dotycząca kanału: jeśli oba urządzenia są podłączone do tej samej sieci Wi-Fi, RC używa kanału Wi-Fi; jeśli żadne nie jest podłączone, RC używa skonfigurowanego kanału.',
	...
	RC_SLAVE_INIT_TOOLTIP: 'Inicjalizuj odbiornik RC z ID parowania (1-255) i kanałem (1-11). Uwaga dotycząca kanału: jeśli oba urządzenia są podłączone do tej samej sieci Wi-Fi, RC używa kanału Wi-Fi; jeśli żadne nie jest podłączone, RC używa skonfigurowanego kanału.',
	...
	TXT_M_OUTPUT_PREFIX: 'Wyjście',
	TXT_COMPONENT_MOTOR: 'Silnik',
	TXT_COMPONENT_LAMP: 'Lampka',
	TXT_LAMP_BRIGHTNESS: 'jasność',
	TXT_M_OUTPUT_STOP: 'Zatrzymaj wyjście',
	TXT_M_OUTPUT_TOOLTIP: 'Wybierz port M i komponent, a następnie ustaw prędkość silnika lub jasność lampki (0 do 512)',
	TXT_M_OUTPUT_STOP_TOOLTIP: 'Zatrzymaj wyjście wybranego portu M',
	TXT_M_OUTPUT_COMPONENT_CONFLICT_WARNING: 'Port M {0} jest używany jako wiele komponentów: {1}. Użyj jednego typu komponentu na port M.',
	TXT_M_OUTPUT_SHARED_PIN_CONFLICT_WARNING: 'Port M {0} współdzieli piny sprzętowe z {1}. Użyj portu M albo powiązanych wyjść O.',
	TXT_M_OUTPUT_UPLOAD_BLOCKED: 'Wykryto konflikt wyjścia TXT M. Popraw zaznaczone bloki wyjść M/O przed uruchomieniem.',
	TXT_M_OUTPUT_CODE_OUTPUT_BLOCKED: 'Wykryto konflikt wyjścia TXT M. Popraw zaznaczone bloki wyjść M/O przed wygenerowaniem kodu.',
	...
	CATEGORY_TXT: 'TXT Controller',
        ...
        PLATFORMIO_UNPINNED_PLATFORM_WARNING: 'Ten istniejący projekt używa platformy PlatformIO bez przypiętej wersji ({0}). Ustawienie nie zostało zmienione. Przypnij wersję platformy przed powtarzalnym wydaniem.',
	...
	FEEDBACK_PANEL_TITLE: "Prześlij opinię",
	FEEDBACK_INTRO: "Opisz, co się stało lub jak ulepszyć Singular Blockly. Konto GitHub nie jest potrzebne.",
	FEEDBACK_KIND_LABEL: "Rodzaj opinii",
	FEEDBACK_KIND_BUG: "Zgłoszenie problemu",
	FEEDBACK_KIND_FEATURE: "Propozycja funkcji",
	FEEDBACK_KIND_QUESTION: "Pytanie dotyczące obsługi",
	FEEDBACK_KIND_OTHER: "Inna opinia",
	FEEDBACK_TITLE_LABEL: "Krótkie podsumowanie",
	FEEDBACK_DESCRIPTION_LABEL: "Co chcesz nam przekazać?",
	FEEDBACK_STEPS_LABEL: "Kroki odtworzenia problemu (opcjonalne)",
	FEEDBACK_EXPECTED_LABEL: "Jakiego wyniku oczekiwano? (opcjonalne)",
	FEEDBACK_BASIC_DIAGNOSTICS_LABEL: "Dołącz podstawowe informacje o środowisku",
	FEEDBACK_BASIC_DIAGNOSTICS_HELP: "Obejmuje wersje aplikacji, rodzinę systemu operacyjnego, architekturę, język oraz typ hosta i obszaru roboczego. Nigdy nie obejmuje kodu źródłowego, ścieżek, identyfikatorów urządzeń, danych sieciowych ani surowych dzienników.",
	FEEDBACK_DIAGNOSTICS_OFF_WARNING: "Podstawowe informacje o środowisku są wyłączone. Nadal możesz wysłać opinię, ale diagnoza może być mniej skuteczna.",
	FEEDBACK_RECENT_EVENTS_LABEL: "Dołącz ostatnie zdarzenia strukturalne",
	FEEDBACK_RECENT_EVENTS_HELP: "Domyślnie wyłączone. Obejmuje tylko ograniczoną liczbę znaczników czasu, etapów, stabilnych kodów zdarzeń i wyników.",
	FEEDBACK_REVIEW_ACTION: "Sprawdź wysyłane dane",
	FEEDBACK_REVIEW_TITLE: "Sprawdź przed wysłaniem",
	FEEDBACK_REVIEW_HELP: "Poniżej znajdują się wszystkie wysyłane dane. Nic nie zostanie przesłane bez potwierdzenia.",
	FEEDBACK_BACK_ACTION: "Wstecz",
	FEEDBACK_CONFIRM_ACTION: "Potwierdź i wyślij",
	FEEDBACK_SENDING: "Wysyłanie opinii…",
	FEEDBACK_SUCCESS: "Dziękujemy. Otrzymaliśmy Twoją opinię.",
	FEEDBACK_REFERENCE_LABEL: "Numer opinii",
	FEEDBACK_COPY_RECOVERY_ACTION: "Kopiuj zapasowy link dostępu",
	FEEDBACK_RECOVERY_COPIED: "Zapasowy link dostępu został skopiowany. Nie udostępniaj go innym.",
	FEEDBACK_ERROR_GENERIC: "Nie udało się wysłać opinii. Sprawdź formularz i spróbuj ponownie.",
	FEEDBACK_ERROR_TIMEOUT: "Upłynął limit czasu żądania. Treść formularza pozostała na miejscu; spróbuj wysłać go ponownie.",
	FEEDBACK_ERROR_RATE_LIMITED: "Wysłano zbyt wiele żądań. Treść formularza pozostała na miejscu; poczekaj chwilę i spróbuj ponownie.",
	FEEDBACK_ERROR_SERVICE_UNAVAILABLE: "Usługa opinii jest tymczasowo niedostępna. Treść formularza pozostała na miejscu; spróbuj ponownie później.",
	FEEDBACK_ERROR_ATTACHMENT: "Zrzut ekranu został odrzucony. Usuń go lub wybierz nowy obraz PNG albo JPEG, a potem ponownie sprawdź dane.",
	FEEDBACK_ERROR_VALIDATION: "Niektóre pola opinii są nieprawidłowe. Sprawdź oznaczone informacje i spróbuj ponownie.",
	FEEDBACK_ERROR_SENSITIVE_CONTENT: "Wykryto dane poufne. Usuń dane logowania, prywatne ścieżki, adresy IP, kod źródłowy lub dane wyjściowe terminala i sprawdź ponownie.",
	FEEDBACK_SCREENSHOT_LEGEND: "Opcjonalny zrzut ekranu",
	FEEDBACK_SCREENSHOT_CHOOSE: "Wybierz jeden zrzut ekranu",
	FEEDBACK_SCREENSHOT_HELP: "Obraz jest ponownie kodowany na tym urządzeniu, ograniczany do 1920 pikseli i 3 MiB oraz wysyłany dopiero po potwierdzeniu.",
	FEEDBACK_SCREENSHOT_PRIVACY: "Przed wysłaniem sprawdź, czy obraz nie zawiera nazwisk, adresów e-mail, ścieżek, treści programu ani innych prywatnych informacji.",
	FEEDBACK_SCREENSHOT_REMOVE: "Usuń zrzut ekranu",
	FEEDBACK_SCREENSHOT_ERROR: "Nie udało się przygotować obrazu. Wybierz obraz PNG lub JPEG mieszczący się w limitach.",
	FEEDBACK_DATA_LEGEND: "Dane wysyłane z opinią",
	FEEDBACK_SCREENSHOT_PREVIEW_ALT: "Podgląd wybranego zrzutu ekranu",
	FEEDBACK_REVIEW_SCREENSHOT_ALT: "Zrzut ekranu, który zostanie wysłany",
	FEEDBACK_OPEN_FAILED: "Nie udało się otworzyć formularza opinii. Spróbuj ponownie.",
	FEEDBACK_PERSONAL_DATA_WARNING: "Nie podawaj imion, adresów e-mail, danych uczniów, poświadczeń, kodu źródłowego, prywatnych ścieżek ani pełnych dzienników.",
	FEEDBACK_SERVICE_DISCLOSURE: "Po wysłaniu opinia jest przechowywana w Cloudflare D1/R2 i prywatnym obszarze GitHub do czasu jej usunięcia. Kopie dostawcy mogą krótko pozostać. Anonimowe publiczne podsumowanie rozwoju powstaje wyłącznie za zgodą właściciela projektu.",
	FEEDBACK_PROVIDE_ACTION: "Prześlij opinię",
	FEEDBACK_MY_FEEDBACK_ACTION: "Moje opinie",
	FEEDBACK_MY_FEEDBACK_TITLE: "Moje opinie",
	FEEDBACK_MY_FEEDBACK_HELP: "Tutaj pojawiają się tylko opinie utworzone przy użyciu tego prywatnego poświadczenia odzyskiwania.",
	FEEDBACK_DETAIL_DESCRIPTION_LABEL: "Opis",
	FEEDBACK_DETAIL_STEPS_LABEL: "Kroki do odtworzenia",
	FEEDBACK_DETAIL_EXPECTED_LABEL: "Oczekiwany wynik",
	FEEDBACK_DETAIL_DIAGNOSTICS_LABEL: "Informacje o środowisku",
	FEEDBACK_DETAIL_ATTACHMENT_INCLUDED: "Zrzut ekranu został dołączony.",
	FEEDBACK_DETAIL_ATTACHMENT_NOT_INCLUDED: "Nie dołączono zrzutu ekranu.",
	FEEDBACK_EMPTY: "Z tej instalacji nie wysłano jeszcze żadnej opinii.",
	FEEDBACK_LOAD_MORE: "Wczytaj więcej",
	FEEDBACK_ADD_MESSAGE_ACTION: "Dodaj informacje",
	FEEDBACK_MESSAGE_LABEL: "Dodatkowe informacje",
	FEEDBACK_DELETE_ONE_ACTION: "Usuń tę opinię",
	FEEDBACK_DELETE_ALL_ACTION: "Usuń wszystkie opinie i dostęp zapasowy",
	FEEDBACK_DELETE_ONE_HELP: "Wpisz DELETE, aby potwierdzić.",
	FEEDBACK_DELETE_ALL_HELP: "Wpisz DELETE ALL, aby potwierdzić. Łącze zapasowe również utraci ważność.",
	FEEDBACK_DELETION_BACKUP_NOTICE: "Główna treść jest usuwana natychmiast; zaszyfrowane kopie mogą krótko pozostać w kopiach bezpieczeństwa, a zatwierdzony przez właściciela zanonimizowany publiczny zapis rozwoju może zostać zachowany.",
	FEEDBACK_OPERATION_SUCCESS: "Zmiana została zapisana.",
	FEEDBACK_PRIVACY_ACTION: "Prywatność",
	FEEDBACK_SUPPORT_ACTION: "Pomoc",
	FEEDBACK_TERMS_ACTION: "Warunki",
	FEEDBACK_NAVIGATION_LABEL: "Sekcje opinii",
	FEEDBACK_STATUS_LABEL: "Stan",
	FEEDBACK_CREATED_LABEL: "Utworzono",
	FEEDBACK_AUTHOR_REPORTER: "Ty",
	FEEDBACK_AUTHOR_MAINTAINER: "Opiekun",
	FEEDBACK_STATUS_RECEIVED: "Otrzymano",
	FEEDBACK_STATUS_TRIAGING: "W trakcie przeglądu",
	FEEDBACK_STATUS_NEEDS_INFO: "Potrzebne informacje",
	FEEDBACK_STATUS_PLANNED: "Zaplanowano",
	FEEDBACK_STATUS_IN_PROGRESS: "W toku",
	FEEDBACK_STATUS_RESOLVED: "Rozwiązano",
	FEEDBACK_STATUS_CLOSED: "Zamknięto",
});
