...
window.languageManager.loadMessages('cs', {
	...
	DIAG_REPORT_TITLE: 'Diagnostická Zpráva MCP Server',
	DIAG_NODEJS_VERSION: 'Verze Node.js',
	DIAG_VERSION_TOO_LOW: 'Verze je příliš nízká ({0}, vyžaduje >= 22.16.0)',
	DIAG_MCP_BUNDLE: 'MCP Server Bundle',
	DIAG_EXISTS: 'Existuje',
	DIAG_FILE_NOT_FOUND: 'Soubor nenalezen',
	DIAG_VSCODE_API_VERSION: 'Verze API VSCode',
	DIAG_REQUIRES_VERSION: 'vyžaduje >= {0}',
	DIAG_WORKSPACE_PATH: 'Cesta k pracovnímu prostoru',
	DIAG_NONE: 'Žádný',
	DIAG_NODEJS_PATH: 'Cesta k Node.js',
	DIAG_SYSTEM_PATH: 'Systémová PATH',
	DIAG_STATUS: 'Stav',
	DIAG_STATUS_OPERATIONAL: 'MCP Server funguje správně',
	DIAG_STATUS_PARTIAL: 'MCP Server je částečně dostupný',
	DIAG_STATUS_UNAVAILABLE: 'MCP Server není dostupný',
	DIAG_RECOMMENDATIONS: 'Doporučení',
	DIAG_GENERATED_AT: 'Vytvořeno',
	DIAG_NODEJS_STATUS: 'Stav Node.js',
	DIAG_AVAILABLE: 'Dostupný',
	DIAG_YES: 'Ano',
	DIAG_NO: 'Ne',
	DIAG_COMPATIBLE: 'Kompatibilní',
	DIAG_ERROR: 'Chyba',
	DIAG_PATH: 'Cesta',
	DIAG_SUPPORTED: 'Podporováno',
	DIAG_VERSION: 'Verze',
	DIAG_OVERALL_STATUS: 'Celkový stav',
	DIAG_OPERATIONAL_SHORT: 'Funkční',
	DIAG_PARTIAL_SHORT: 'Částečně dostupný',
	DIAG_UNAVAILABLE_SHORT: 'Nedostupný',
	REC_INSTALL_NODEJS: 'Nainstalujte Node.js 22.16.0 nebo novější',
	REC_SET_NODEJS_PATH: 'Pokud je již nainstalován, zadejte cestu k Node.js v nastavení (singularBlockly.mcp.nodePath)',
	REC_UPGRADE_NODEJS: 'Aktualizujte Node.js na verzi 22.16.0 nebo novější (současná: {0})',
	REC_RUN_COMPILE: 'Spusťte `npm run compile` nebo přeinstalujte rozšíření',
	REC_UPGRADE_VSCODE: 'Aktualizujte VSCode na verzi 1.105.0 nebo novější',
	REC_OPEN_PROJECT: 'Otevřete složku projektu pro použití všech funkcí',
	...
	// === TXT Controller ===
	UPLOAD_BUTTON_TITLE_TXT: 'Nahrát do TXT kontroléru',
	TXT_CONNECTION_PANEL_TITLE: 'Nastavení připojení TXT kontroléru',
	TXT_HOST_LABEL: 'IP adresa',
	TXT_USERNAME_LABEL: 'Uživatelské jméno',
	...
	TXT_CONFIG_SAVED: 'Nastavení uloženo',
	TXT_UPLOAD_STAGE_CONNECTING: 'Připojování k TXT kontroléru...',
	TXT_UPLOAD_STAGE_UPLOADING: 'Nahrávání programu...',
	TXT_UPLOAD_STAGE_EXECUTING: 'Spouštění programu...',
	TXT_UPLOAD_STAGE_COMPLETED: 'Dokončeno',
	TXT_UPLOAD_STAGE_FAILED: 'Nahrávání selhalo',
	TXT_RUN_SUCCESS: 'Program dokončen',
	TXT_RUN_FAILED: 'Chyba spuštění programu: {0}',
	TXT_STOP_SUCCESS: 'Program zastaven',
	// Test Panel UI
	TXT_TEST_PANEL_TITLE: 'Testovací panel TXT I/O',
	TXT_TEST_PANEL_BUTTON_TITLE: 'Testovací panel TXT I/O',
	TXT_TEST_MOTORS_TITLE: 'Motory',
	TXT_TEST_OUTPUTS_TITLE: 'Výstupy',
	TXT_TEST_INPUTS_TITLE: 'Vstupy',
	TXT_TEST_STOP_ALL: 'ZASTAVIT VŠE',
	TXT_TEST_MOTOR_FWD: '▶ Dopředu',
	TXT_TEST_MOTOR_BWD: '◀ Dozadu',
	TXT_TEST_STATUS_CONNECTED: 'Připojeno',
	TXT_TEST_STATUS_DISCONNECTED: 'Odpojeno',
	TXT_TEST_STATUS_PAUSED: 'Pozastaveno',
	TXT_TEST_STATUS_CONNECTING: 'Připojování…',
	TXT_SETUP: 'TXT Inicializace',
	TXT_SETUP_TOOLTIP: 'Inicializuje TXT kontrolér jednou a připraví sdílené hardwarové prostředky pro všechny TXT procesy.',
	TXT_PROCESS_PREFIX: 'TXT Proces:',
	TXT_PROCESS_TOOLTIP: 'Definuje jeden TXT proces. Název je volitelný a slouží pouze pro zobrazení nebo diagnostiku.',
	TXT_INIT: 'Inicializovat TXT kontrolér',
	TXT_INIT_TOOLTIP: 'Připojit k fischertechnik TXT kontroléru',
	TXT_MOTOR_SPEED: 'Motor',
	TXT_MOTOR_SPEED_SET: 'nastavit rychlost',
	TXT_MOTOR_SPEED_TOOLTIP: 'Nastavit rychlost motoru (-512 až 512)',
	TXT_MOTOR_STOP: 'Zastavit motor',
	TXT_MOTOR_STOP_TOOLTIP: 'Zastavit zadaný motor',
	TXT_OUTPUT: 'Výstup',
	TXT_OUTPUT_SET: 'nastavit',
	TXT_OUTPUT_TOOLTIP: 'Zapnout nebo vypnout výstup',
	TXT_INPUT_READ: 'Číst vstup',
	TXT_INPUT_READ_TOOLTIP: 'Číst hodnotu digitálního vstupu',
	TXT_INPUT_SENSOR_PREFIX: 'Číst',
	TXT_SENSOR_BUTTON: 'Tlačítko',
	TXT_SENSOR_GATE: 'Světelná závora',
	TXT_SENSOR_ULTRASONIC: 'Ultrazvuk',
	TXT_INPUT_SENSOR_TOOLTIP: 'Vyberte typ senzoru a přečtěte hodnotu (tlačítko/světelná závora vrací 0 nebo 1, ultrazvuk vrací vzdálenost v cm)',
	TXT_WAIT: 'Čekat',
	TXT_WAIT_UNIT: 'ms',
	TXT_WAIT_TOOLTIP: 'Čekat zadaný počet milisekund',
	TXT_STOP_ALL: 'Zastavit všechny motory a výstupy',
	TXT_STOP_ALL_TOOLTIP: 'Zastavit všechny motory a vypnout všechny výstupy',
	TXT_DIRECTION_FORWARD: 'vpřed',
	TXT_DIRECTION_BACKWARD: 'vzad',
	TXT_STATE_ON: 'ZAP',
	TXT_STATE_OFF: 'VYP',
		TXT_MAIN: 'TXT Hlavní Program',
	TXT_MAIN_TOOLTIP: 'Hlavní vstupní bod programu TXT Controller. Všechny bloky musí být umístěny zde.',
	TXT_ORPHAN_WARNING: 'Tento blok musí být umístěn v bloku "Hlavní program TXT"',
	TXT_ORPHAN_WARNING_MULTI: 'Tento blok musí být umístěn v bloku „TXT Inicializace“ nebo „TXT Proces“',
	TXT_SETUP_DUPLICATE_WARNING: 'Bylo nalezeno více bloků „TXT Inicializace“. Odstraňte přebytečné bloky.',
	TXT_SETUP_REQUIRED_WARNING: 'TXT workspace vyžaduje jeden blok „TXT Inicializace“.',
