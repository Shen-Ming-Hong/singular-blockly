...
framework = arduino`,
	...
	esp32: {
		name: 'ESP32',
		digitalPins: [
			['GPIO0 (Touch/Strapping)', '0'],
			['GPIO1 (TX0)', '1'],
			['GPIO2 (Touch/Strapping)', '2'],
			['GPIO3 (RX0)', '3'],
			['GPIO4 (Touch/Strapping)', '4'],
			['GPIO5 (Strapping)', '5'],
			// GPIO 6-11 連接到內部 SPI Flash，不建議使用
			['GPIO12 (Touch/Strapping)', '12'],
			['GPIO13 (Touch)', '13'],
			['GPIO14 (Touch)', '14'],
			['GPIO15 (Touch/Strapping)', '15'],
			['GPIO16', '16'],
			['GPIO17', '17'],
		...
		// ESP32 所有數位引腳都可作為中斷引腳（除了僅輸入的引腳只能作為輸入中斷）
		interruptPins: [
			['GPIO0 (Touch/Strapping)', '0'],
			['GPIO1 (TX0)', '1'],
			['GPIO2 (Touch/Strapping)', '2'],
		...
		analogPins: [
			['GPIO32 (ADC1_CH4)', '32'],
			['GPIO33 (ADC1_CH5)', '33'],
			['GPIO34 (ADC1_CH6/Input only)', '34'],
			['GPIO35 (ADC1_CH7/Input only)', '35'],
			['GPIO36 (ADC1_CH0/VP/Input only)', '36'],
			['GPIO39 (ADC1_CH3/VN/Input only)', '39'],
			// ADC2 通道在使用 WiFi 時不可用，因此不列入預設類比腳位
		],
		analogOutputRange: {
			min: 0,
		...
		// ESP32 特殊引腳功能
		strappingPins: [0, 2, 4, 5, 12, 15], // 啟動模式引腳
		touchPins: [0, 2, 4, 12, 13, 14, 15, 27, 32, 33], // 電容式觸控引腳
