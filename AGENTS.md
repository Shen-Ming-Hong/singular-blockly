...
- Runtime/tooling baseline: TypeScript 6.0.3, Blockly 13.2.1, `@blockly/theme-modern` 13.2.0, VS Code `^1.126.0`, Node.js 24.20.0 for the default contributor toolchain (minimum supported: 22.16.0).
